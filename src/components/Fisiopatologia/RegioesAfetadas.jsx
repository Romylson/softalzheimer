    ...
    <div className="regioes-afetadas" style={{ display: "flex", flexDirection: "column", gap: "1.5rem", marginTop: "2rem" 
      ...
      {/* Volume cerebral */}
       <div style={{ display: "flex", flexDirection: "column", gap: "0.25rem" }}>
        ...
        <p className="text-muted small ms-3">Imagem: Volume cerebral - Autor: {autorVolume}</p>
      </div>
      {/* Hipocampo */}
       <div style={{ display: "flex", flexDirection: "column", gap: "0.25rem" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
        ...
        <p className="text-muted small ms-3">Imagem: Hipocampo - Autor: {autorHipocampo}</p>
         </div>
      {/* Córtex */}
      <div style={{ display: "flex", flexDirection: "column", gap: "0.25rem" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
        ...
        <p className="text-muted small ms-3">Imagem: Córtex cerebral - Autor: {autorCortex}</p>
         </div>
      {/* Sulcos e Giros */}
      <div style={{ display: "flex", flexDirection: "column", gap: "0.25rem" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
        ...
        <p className="text-muted small ms-3">Imagem: Sulcos e giros - Autor: {autorSulcos}</p>
      </div>
